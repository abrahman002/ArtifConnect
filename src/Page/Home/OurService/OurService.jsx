    ...
    return (
        <div className='service-container w-full pb-10 pt-10 lg:pt-0' >
            <div className='lg:grid grid-cols-5 gap-2 card-group lg:top-[-100px] lg:mt-0 mt-16  lg:relative  z-10 lg:px-14 px-5 ' data-aos="fade-up">
                <div className='card services  card-effect lg:w-56 p-10 bg-white flex items-center flex-col  '>
                ...
                <div className='card services  card-effectlg:w-56 p-10 bg-white lg:mt-0 mt-5 flex items-center flex-col'>
